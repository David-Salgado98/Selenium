...
public class TC07_AddWishlist {
	...
	@Test(description = "Login to the website", priority = 2)
	public void S002_Login() throws InterruptedException {
	...
	@Test(description = "Type the mail and password registered and click on the 'sign in' button", priority = 3)
	public void S003_TypeMailAndPassword() {
		driver.get("https://automationexercise.com/");
	...
	@Test(description = "Move your cursor over Women's link and click on sub menu 'T-shirts'", priority = 4)
	public void S004_GoTshirtPage() throws InterruptedException {
		// Women menu
	...
	@Test(description = "Add the product to wishlist", priority = 5)
	public void S005_AddToCart() throws InterruptedException {
	...
	@Test(description = "Add the product to wishlist", priority = 6)
	public void S006_ReviewCart() throws InterruptedException {
